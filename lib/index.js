...
function Nightmare () {
  if (!(this instanceof Nightmare)) return new Nightmare.apply(undefinded, arguments);
  var options = {},
    stringArgs = [],
    arg, i, len;
...
Nightmare.prototype.setupInstance = function(done) {
  ...
  var weak = this.options.weak;
  var dnodeOpts = {};
  var args = clone(this.stringArgs);
  var itemArgs = { port: port };
